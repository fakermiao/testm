/*
 * @Author: 苗金标
 * @Date: 2023-03-26 18:28:35
 * @LastEditors: 苗金标
 * @LastEditTime: 2023-03-27 10:34:17
 * @Description: 
 */
#pragma once
#include "../common.h"
...
namespace pipeline{
    typedef struct wb_commit_op_info_t{
        ...
        virtual void print(std::string indent){
            ...
            std::cout << blank << "execption_value = 0x" << fillzero(8) << outhex(execption_value);

            std::cout << indent << "\trs1 = " << rs1;
            std::cout << blank << "arg1_src1 = " << outenum(arg1_src);

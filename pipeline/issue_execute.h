/*
 * @Author: 苗金标
 * @Date: 2023-03-04 15:07:34
 * @LastEditors: 苗金标
 * @LastEditTime: 2023-03-26 16:30:52
 * @Description: 
 */
#ifndef ISSUE_EXECUTE_H
#define ISSUE_EXECUTE_H
#include "../common.h"
#include "../config.h"
...
namespace pipeline
{
    typedef struct issue_execute_pack_t : public if_print_t
    {
        ...
        virtual void print(std::string indent){
            ...
            std::cout << blank << "execption_value = 0x" << outhex(execption_value); 

/*
 * @Author: 苗金标
 * @Date: 2023-03-02 14:59:13
 * @LastEditors: 苗金标
 * @LastEditTime: 2023-03-27 19:19:00
 * @Description: 发射队列发射指令到对应的功能单元发射队列
 */
#ifndef ISSUE_H
#define ISSUE_H
#include "../common.h"
...
namespace pipeline{
    ...
    class issue : public if_print_t{
        ...
        public:
            ...
            issue_feedback_pack_t run(wb_feedback_pack_t wb_feedback_pack,commit_feedback_pack_t commit_feed_pack);
            virtual void print(std::string indent); 
    };
}
#endif